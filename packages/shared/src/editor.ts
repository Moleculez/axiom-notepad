...
const catalogue = [
  ...
  ["minimap", "Toggle minimap", "View", "workspace", []],
  ["focusMinimap", "Focus minimap", "View", "workspace", []],
  ["returnToCursor", "Return to cursor", "View", "workspace", []],
  ...
  ["toc", "Table of contents", "Research", "editor", []],
  ["metadata", "Document metadata", "Research", "editor", []],
      ...
      (
        {
          ...
          toc: "toc outline contents sections",
          metadata: "metadata yaml properties frontmatter",
          heading1: "h1",
          heading2: "h2",
          heading3: "h3",
          heading4: "h4",
